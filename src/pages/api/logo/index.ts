...
// The fast model. The slower one was chosen while the prompt was full of
// prohibitions that suited it; given a plain request this one is better and
// takes about five seconds rather than ninety.
...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  if (!url) return json({ error: failure || 'drawing failed' }, 502);
