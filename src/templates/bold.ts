// BOLD TEMPLATE
// Strong colors, big typography, impactful, energetic
...
export function generateBoldTemplate(data: TemplateData): string {
  const {
    business,
    tagline,
    description,
  ...
  return `---
// Generated by Garage Web - Bold Template
...
<html lang="en">
    ...
    <style>
      ...
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      @media (max-width: 968px) {
        ...
        .services { clip-path: none; margin: 0; padding: 80px 0; }
        .contact { clip-path: none; padding: 80px 0; }
  ...
  <body>
    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content">
          ...
          <h1>
            ${(tagline || business).split(' ').slice(0, 2).join(' ')}
            <span class="highlight">${(tagline || business).split(' ').slice(2).join(' ') || 'Excellence'}</span>
          </h1>
          <p>${description || 'We deliver exceptional results with unmatched dedication. Experience the difference.'}</p>
      ...
      <div class="container">
        <div class="about-content">
          <div class="about-text">
            ...
            <p>${aboutText || 'With years of experience and a commitment to excellence, we deliver results that exceed expectations. Our team of dedicated professionals is here to serve you.'}</p>
            <div class="about-features">
              ...
              <div class="feature">
                ...
                <div class="feature-label">Projects Done</div>
              </div>
              <div class="feature">
      ...
      <div class="container">
        <div class="contact-grid">
          <div class="contact-info">
            <h2>Let's Talk</h2>
            <p>Ready to start your project? Get in touch and let's make it happen.</p>
    ...
    <footer>
      <div class="container">
        <div class="footer-text">© ${new Date().getFullYear()} ${business}</div>
        <div class="footer-text">Redesigned by <a href="https://garage.co.nz">Garage</a></div>
      </div>
    </footer>
    ...
    <div class="countdown-banner">
      ...
      <a href="#contact" class="countdown-btn">I Want This</a>
    </div>
